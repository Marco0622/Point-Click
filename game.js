...
function game() {
  ...
  function historical() {
    ...
    history.forEach((m) => {
      ...
      div.innerHTML = `
          ...
          `;
      contentMain.insertBefore(div, contentMain.firstChild);
    });
  }
  ...
  function step(timestamp) {
    ...
    for (const m of movers) {
      ...
      if (dist < 5)
        pickNewTarget(m); // Si proche de la cible, choisir une nouvelle cible
      else {
...
const btnIconHelp = document.querySelector(".help img");
const help = document.getElementById("help");
const contentHelp = document.querySelector(".help .container");

btnIconHelp.addEventListener("click", function (e) {
...
//Ouverture
function openHelp() {
  btnIconHelp.src = "img/arrow.png";
  contentHelp.style.display = "block";
  help.classList.add("swapContent");
}

//Fermeture
function closeHelp() {
  btnIconHelp.src = "img/settingGame.png";
  contentHelp.style.display = "none";
  help.classList.remove("swapContent");
}
